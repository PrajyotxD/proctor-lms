    ...
    return (
      <Card className="w-full max-w-md">
        <CardContent className="p-8 text-center">
          <div className="mx-auto mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg border border-yellow-500/30 bg-yellow-500/10 text-yellow-600 dark:text-yellow-400">
      ...
      <Card className="w-full max-w-md">
        <CardContent className="space-y-6 p-8">
          <div className="text-center">
            <div className="mx-auto mb-4 inline-flex h-16 w-16 items-center justify-center rounded-lg border border-primary/30 bg-primary/10">
              <Shield className="h-8 w-8 text-primary" />
            </div>
            <Badge variant="success" className="mb-3">
              Session Active
            </Badge>
            <h2 className="text-2xl font-bold mb-2 text-foreground">Signed in as {profile.role}</h2>
